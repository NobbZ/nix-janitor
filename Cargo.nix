...
in {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".is-root."0.1.2" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "04a4202a60e86f1c9702706bb42270dadd333f2db7810157563c86f17af3c873";
    };
    dependencies = {
      ${
        if hostPlatform.isUnix
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".users."0.10.0" {inherit profileName;};
      ${
        if hostPlatform.isWindows
        then "winapi"
        else null
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rstest."0.18.1" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "2b96577ca10cb3eade7b337eb46520108a67ca2818a24d0b63f41fd62bc9651c";
    };
    features = builtins.concatLists [
      ["async-timeout"]
      ["default"]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rstest_macros."0.18.1" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "225e674cf31712b8bb15fdbca3ec0c1b9d825c5a24407ff2b7e005fb6a29ba03";
    };
    features = builtins.concatLists [
      ["async-timeout"]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustix."0.38.4" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".errno."0.3.2" {inherit profileName;};
      ${
      ...
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".linux-raw-sys."0.4.3" {inherit profileName;};
      ${
        if hostPlatform.isWindows
        then "windows_sys"
        else null
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tempfile."3.7.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustix."0.38.4" {inherit profileName;};
      ${
        if hostPlatform.isWindows
        then "windows_sys"
        else null
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tokio."1.29.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.68" {inherit profileName;};
  ...
  "registry+https://github.com/rust-lang/crates.io-index".users."0.10.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "aa4227e95324a443c9fcb06e03d4d85e91aabe9a5a02aa818688b6918b6af486";
    };
    features = builtins.concatLists [
      ["cache"]
      ["default"]
