...
let
  nixifiedLockHash = "247a04b452ecaca484a2f1eb92554f4d6c179a16c58211e44af29c171914c43d";
...
in
{
  ...
  workspace = {
    janitor = rustPackages.unknown.janitor."0.2.0";
  };
  ...
  "unknown".janitor."0.2.0" = overridableMkRustCrate (profileName: rec {
    name = "janitor";
    version = "0.2.0";
    registry = "unknown";
